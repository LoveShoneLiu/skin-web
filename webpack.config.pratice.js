...
console.log('ahhaahhaahhaahhaahhaahhaahhaahhaahhaahhaahhaahhaahhaahhaahhaahha');

const config = {
    entry: {
        "main": path.resolve(__dirname, './pratice/pratice.js'),
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            filename: 'pratice.html',
            // inject: false,
            template: './pratice/pratice.html',
        }),
    ...
    resolve: {
        alias: {
            jspath: path.resolve(__dirname, 'pratice/src/js/'),
            csspath: path.resolve(__dirname, 'pratice/src/css/'),
            rootPath: path.resolve(__dirname, 'pratice/src/'),
            componentsPath: path.resolve(__dirname, 'pratice/src/components/'),
